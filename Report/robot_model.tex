...
We have decided to use Quadrotor as our robot. Workspace for quadrotor is \(R^3\) and Configuration space is \(R^3 \times SO(3)\). We will plan in the workspace \(R^3\).
